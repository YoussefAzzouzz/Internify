...
public class DemandRestController {
    ...
    private static final String UPLOAD_DIR = "C:/Users/youss/Desktop/InternshipDemands/src/main/resources";
    ...
    public ResponseEntity<?> parseCvFromDemand(@PathVariable Long id) {
        ...
        try {
            ...
            try {
                System.out.println("Sending request to ML service at http://localhost:5002/predict-cluster ...");
                response = restTemplate.postForEntity(
                        "http://localhost:5002/predict-cluster", request, Map.class
                );
            } catch (Exception e) {
    ...
    public ResponseEntity<?> predictClusterForDemand(@PathVariable Long id) {
        ...
        try {
            ...
            RestTemplate restTemplate = new RestTemplate();
            String flaskApiUrl = "http://localhost:5002/predict-cluster";
    ...
    public Map<String, Object> parseCV(File cvFile) throws IOException {
        String scriptPath = "C:\\Users\\youss\\OneDrive\\Documents\\Internify-Demands_Management\\cv_parser.py";
        ...
        env.put("PYTHONPATH", "C:\\Users\\youss\\OneDrive\\Documents\\Internify-Demands_Management");
